...
export default function Premium() {
  ...
  const PLANS = [
    {
      ...
      features: lang === 'en' ? [
        ...
        { label: '✈️ Travel Planner',                      included: false },
        ...
        { label: '✈️ Piano Viaggio',                       included: false },
    ...
    },
    {
      ...
      features: lang === 'en' ? [
        ...
        { label: '✈️ Travel Planner (1×/month)',           included: true  },
        { label: 'Unlimited digital closet',              included: true  },
        ...
        { label: '✈️ Piano Viaggio (1×/mese)',              included: true  },
        { label: 'Armadio digitale illimitato',            included: true  },
    ...
    },
    {
      ...
      features: lang === 'en' ? [
        ...
        { label: '✈️ Travel Planner (1×/week)',            included: true },
        { label: 'Unlimited digital closet',              included: true },
        { label: 'Advanced outfit builder',               included: true },
        { label: 'Social feed',                           included: true },
        ...
        { label: '✈️ Piano Viaggio (1×/settimana)',         included: true },
        { label: 'Armadio digitale illimitato',            included: true },
        { label: 'Outfit builder avanzato',                included: true },
        { label: 'Social feed',                            included: true },
  ...
  const tableRows = lang === 'en' ? [
    ...
    { label: '✈️ Travel Planner/month', free: '—',    premium: '1/mo', premiumPlus: '1/wk' },
    ...
    { label: '✈️ Piano Viaggio/mese',  free: '—',     premium: '1/mese', premiumPlus: '1/sett' },
