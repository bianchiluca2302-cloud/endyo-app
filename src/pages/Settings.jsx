...
function StylistUsage({ language }) {
  ...
  const L = {
    it: {
      ...
      armoLabel:    'Stagione Colore',
      uploadLabel:  'Caricamenti Vestiti',
      blocked:      'Bloccato (solo Premium)',
      extraCredits: 'Utilizzi extra',
      buyPack:      'Acquista un pacchetto',
      packS:        '40 caricamenti · €2,49',
      packM:        '100 caricamenti · €4,99',
      packL:        '300 caricamenti · €9,99',
